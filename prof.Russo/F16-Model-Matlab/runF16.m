...
% ==========================================
h0 = -5000*ft2m; % Faccimolo nascere a 5000 piedi (il meno indica "su" nel sistema aerospaziale NED)
Vt0 = 800*ft2m;  % Velocità altissima, circa Mach 0.8
...
disp('Dati caricati! Vai su Simulink e premi Play.');