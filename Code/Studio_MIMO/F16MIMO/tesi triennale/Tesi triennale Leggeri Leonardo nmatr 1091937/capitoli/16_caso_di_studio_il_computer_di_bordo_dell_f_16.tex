...
Il caso di studio analizzato dal progetto tratta la simulazione del computer di bordo di un caccia F-16, l'implementazione in \texttt{src/app/F16\_Computer/F16\_Computer.cpp}. Questo programma istanzia simultaneamente su 7 core fisici, ciascuno dei quali è un sottosistema avionico distinto del velivolo, infatti ogni sottosistema esegue la propria Periodic Task attraverso la politica di schedulazione \textit{Rate Monotonic}.
...
% ============================================================================
Il sistema di navigazione su cui si basa la mia implementazione real-time si basa sulle informazioni presenti in questo documento \cite{Navigation_System}, in questo documento viene simulata l'azione di due tecnologie complementari: la ricezione GPS per la posizione assoluta e la navigazione inerziale per la stima continua dello stato cinematico del velivolo.
