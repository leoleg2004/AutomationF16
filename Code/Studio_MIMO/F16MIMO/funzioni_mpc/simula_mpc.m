function [storia_x, storia_u] = simula_mpc(mpc_prob, x_iniziale, t_sim, A_long_ds, B_ctrl_ds, dU_max)
    ...
    for t = 1:t_sim
        ...
        if t == 1
            ...
            h_pred = plot3(X_pred(3,:), X_pred(4,:), X_pred(2,:), '-rs', 'LineWidth', 2, 'MarkerFaceColor', 'r', 'DisplayName', 'Predizione Ottima');
            h_traj = plot3(storia_x(3,1:t), storia_x(4,1:t), storia_x(2,1:t), '-b', 'LineWidth', 2.5, 'DisplayName', 'Traiettoria Effettiva');
            ...
            set(h_pred, 'XData', X_pred(3,:), 'YData', X_pred(4,:), 'ZData', X_pred(2,:));
            set(h_traj, 'XData', storia_x(3,1:t), 'YData', storia_x(4,1:t), 'ZData', storia_x(2,1:t));
            drawnow limitrate;
        end
    ...
    set(h_traj, 'XData', storia_x(3,:), 'YData', storia_x(4,:), 'ZData', storia_x(2,:));
